...
# AWS configurations
region = "ap-southeast-1"  # Replace with your preferred AWS region (Singapore)
bucket_name = "sports-analytics-data-lake-951951452"  # Change to a unique S3 bucket name
